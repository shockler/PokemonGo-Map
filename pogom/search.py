                    ...
                    if consecutive_empties >= 2:
                        ...
                        if len(captcha_url) > 1:
                            ...
                            if 'ERROR' in captcha_token:
                                log.info("Unable to resolve captcha, please check your 2captcha API key and/or wallet balance")
...
def token_request(args, status, url):
    ...
    try:
        ...
        break
    except IndexError: # This implies that the retuned response was an error
        return 'ERROR'
